...
uint8_t CAN_DRV_FUNC can_spi_query(ican_t *ican, uint8_t);
void CAN_DRV_FUNC can_r_reg(ican_t *ican, uint8_t, void *, uint8_t);
void CAN_DRV_FUNC can_w_reg(ican_t *ican, uint8_t, void *, uint8_t);
void CAN_DRV_FUNC can_w_bit(ican_t *ican, uint8_t, uint8_t, uint8_t);

#ifndef __SANCUS_IO_QUIET
    void CAN_DRV_FUNC can_dump_regs(ican_t *ican);
#else
    #define can_dump_regs(can)
#endif
